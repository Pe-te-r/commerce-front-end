...
import { useSetAuthCodeMutation } from "../slice/userSlice";
...
const Login = () => {
  ...
  const [setAuth,{isLoading:authLoading,isSuccess:authSuccess,data:authData}] = useSetAuthCodeMutation()

  const [formData, setFormData] = useState({
    email: "petermburu8526@gmail.com",
    password: "1234",
